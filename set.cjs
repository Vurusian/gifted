...
const config = {
  ...
  OWNER_NAME: process.env.OWNER_NAME || "Virusi ᴛᴇᴄʜ",
  AUTO_BLOCK: process.env.AUTO_BLOCK || "212,99,1",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "",
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "254728746852,254748721079",
